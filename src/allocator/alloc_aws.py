...
def alloc(demand, prices, available_sp, market_option, res_duration):
    """ Allocates the demand in the on-demand and savings plans markets, considering the aws strategy
    """

    # order by the discounts
    # allocate first the instances with the biggest discounts
    # for instances with the same discounts, the larger is allocated first
